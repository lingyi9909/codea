...
type ChatMessage struct { Role Role; Content string; Finished bool; TurnID string; Agent string; Model string }
type ToolStatus string
const ( ToolRunning ToolStatus = "running"; ToolSuccess ToolStatus = "success"; ToolFailed ToolStatus = "failed" )
type ToolActivity struct { Name string; CallID string; Status ToolStatus }
type ViewMode string
const ( ViewNormal ViewMode = "normal"; ViewVerbose ViewMode = "verbose"; ViewFocus ViewMode = "focus" )
...
type Model struct {
	...
	activeModelStrategy modelprofile.Strategy
...
func NewModel(client runtime.AgentRuntime) *Model {
	return &Model{
		...
		activeModelStrategy: mediumModelStrategy(),
